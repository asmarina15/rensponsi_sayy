...
let basemap = L.tileLayer(
  ...
  {
    attribution:
      'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a> contributors | <a href="https://unsorry.net" target="_blank">unsorry@2020</a>',
  }
);
basemap.addTo(map);
...
function mapMovement(e) {
  ...
  //Create marker
  marker
    .setLatLng([mapcenter.lat.toFixed(5), mapcenter.lng.toFixed(7)])
    .update();
  marker.on("dragend", dragMarker);
}
